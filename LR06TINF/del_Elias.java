...
public class del_Elias {
	 public static void main(String[] args) {
		 ...
		 int num = in.nextInt();
		 System.out.println("Код: "+del_EliasCode(num));
		 System.out.println("Декодирование: "+del_EliasDecode(del_EliasCode(num)));
		 Testsdel_EliasCode(); //
		 in.close();
	 }
	 ...
	 static int del_EliasDecode(String strcode) {
		 ...
		 //System.out.println("удален унарный код " + bufcode);
		 ...
		 //System.out.println("удален гамма код " + bufcode);
		 k = --result;
